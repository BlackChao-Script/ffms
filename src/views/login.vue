  ...
  <div class="container" :class="{ 'sign-up-mode': signUpMode }">
    ...
    <div class="forms-container">
      <div class="signin-signup">
        <!-- 登录 -->
        <LoginForm :loginUser="LoginData.loginUser" :rules="LoginData.rules" />

        <!-- 注册 -->
        <RegisterForm
          :registerUser="registerDate.registerUser"
          :registerRules="registerDate.registerRules"
        />
      </div>
    </div>
    <!-- 左右切换动画 -->
