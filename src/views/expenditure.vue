...
import { getlistExpenditure, addExpenditure, updateExpenditure } from '@/api/expenditure'
...
const getInvestmentData = async () => {
  const res = await getlistExpenditure(id.value, PaginationRef.value.pageData.pageNum + '', PaginationRef.value.pageData.pageSize + '')
